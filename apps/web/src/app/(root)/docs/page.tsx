          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Just type any word in the search bar and hit enter. That's it.
                No sign up or anything, just definitions that make sense.
              </p>
            ...
            <ul className="list-disc pl-6 space-y-3">
              <li>
                ...
                <p className="text-muted-foreground mt-1">
                  We explain words like you'd explain them to a friend - in
                  plain language that actually makes sense.
                </p>
              </li>
              ...
              <li>
                ...
                <p className="text-muted-foreground mt-1">
                  Words mean different things in different situations. We give
                  you real examples of how words are actually used today.
                </p>
              </li>
              ...
              <li>
                ...
                <p className="text-muted-foreground mt-1">
                  We keep up with how language actually evolves - including
                  slang, internet terms, and new meanings for old words.
                </p>
              </li>
            </ul>
          </div>
