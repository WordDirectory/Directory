...
export const metadata: Metadata = {
  ...
  description: "Frequently asked questions about Word Directory - from how our definitions are created to our commitment to keeping the service free forever.",
  openGraph: {
    title: "Frequently Asked Questions | Word Directory",
    description: "Common questions about Word Directory - from how our definitions are created to our commitment to keeping the service free forever.",
